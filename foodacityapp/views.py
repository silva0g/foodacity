...
from foodacityapp.forms import UserForm, RestaurantForm, UserFormForEdit, MealForm
from django.contrib.auth import authenticate, login

from django.contrib.auth.models import User
from foodacityapp.models import Meal, Order, Driver # Import the Meal, Order and Driver  Model
...
def restaurant_add_meal(request):
    ...
    return render(request, 'restaurant/add_meal.html', {
        "form": form # We put this to pass the form
    })
# Fim do modelo add meal
# Inicio da parte do edit
@login_required(login_url='/restaurant/sign-in/')
...
def restaurant_report(request):
    # Calculate Restaurant revenue and number of order of current_Week
    from datetime import datetime, timedelta # Import datetime
    # In here we gonna put two array:
    revenue = []
    orders = []
    ...
    # TOP 3 meals
    # Because we break it we need to put the slash
    ...
    # Fim do codigo para calcular a estatistica para meals e drivers!!!
...
def restaurant_front(request):

    return render(request, 'restaurant/front.html')
