...
from foodacityapp.models import Restaurant, \
    Meal, \
    Customer, \
    Order, \
    Driver, \
...
class OrderCustomerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Customer
        fields = ("id", "name", "avatar", "phone", "adress")
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ("id", "customer", "restaurant", "driver", "order_details", "total", "status", "adress")
