...
#Added to enable images uploading capabilities
from django.conf.urls.static import static
from django.conf import settings

from foodacityapp import views, apis
...
urlpatterns = [
    ...
    url(r'^restaurant/meal/edit/(?P<meal_id>\d+)/$', views.restaurant_edit_meal, name = 'restaurant_edit_meal'),
    url(r'^restaurant/order/$', views.restaurant_order, name = 'restaurant_order'),
    url(r'^restaurant/front/$', views.restaurant_front, name = 'restaurant_front'),
    ...
    # New url for order notification API
    ...
    url(r'^api/customer/driver/location/$', apis.customer_driver_location),# Para o cliente saber a localizaçao do driver
